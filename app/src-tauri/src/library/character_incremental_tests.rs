...
#[test]
fn character_reference_refresh_with_invalid_competitor_finishes_without_worker() {
    let f = Fixture::new();
    ...
    let config = RuntimeConfig {
        ...
        script: PathBuf::from("unused-worker.py"),
        models: PathBuf::from("unused-models"),
    };
    ...
    let item_state: String = c
        ...
        .unwrap();
    assert_eq!(item_state, "completed");
    let request_state: String = c
        ...
        .unwrap();
    assert_eq!(request_state, "completed");
}
