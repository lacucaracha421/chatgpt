...
createRoot(document.getElementById("root")!).render(<LibraryProvider gateway={gateway}><CharacterLab api={createCharacterFixture()} classifications={fixtureClassifications} initialSeriesId="series" targetId="hina" onClose={()=>{ document.getElementById("root")!.textContent="검토 창 닫힘 · 운영 라이브러리는 사용하지 않았습니다."; }} /></LibraryProvider>);
