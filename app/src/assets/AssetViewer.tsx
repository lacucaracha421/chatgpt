...
export function AssetViewer({ items, activeId, onActiveIdChange, onClose, onToggleFavorite, onTrash }: { items: AssetSummary[]; activeId: string | null; onActiveIdChange: (id: string) => void; onClose: () => void; onToggleFavorite?: (asset: AssetSummary) => void; onTrash?: (asset: AssetSummary) => void }) {
