...
it("shows the collection name as the location in a collection detail view", () => {
  const collections: CollectionSummary[] = [{ id: "collection-1", name: "엘든 링", description: null, type: "game", coverAssetId: null, selectedWorkArtworkId: null, assetCount: 3, unreadReleaseCount: 0, year: null, author: null, director: null, externalScore: null, myScore: null, genres: null, overview: null, showcase: false, createdAt: "2026-08-10T00:00:00Z", updatedAt: "2026-08-10T00:00:00Z" }];
