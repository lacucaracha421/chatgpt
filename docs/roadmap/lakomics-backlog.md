...
Status: `TODO` — reported 2026-09-27 on the PC app (release build).
- Bug: the character folder thumbnail brings up a drag-and-drop (file drop) selection window when it should not.
- Bug: pressing the edit (pencil) icon on a character folder does nothing.
