...
| [0036 Staged server authority](0036-staged-server-authority.md) | Proposed | Domain epochs, legacy-write fencing, idempotent operations and recovery; current character projection is read-only |
