...
| [0035 Encrypted personal Notes](0035-encrypted-personal-notes.md) | **Accepted** | 별도 복구키, 로컬 암호문 저장, Notes 전용 양방향 revision 동기화; Notes v2 checklists, colours, safe Markdown, item-level merge with automatic both-copies on collision (amended 2026-09-24) |
...
| [0039 Lakomics encrypts the Private Vault itself](0039-lakomics-encrypted-private-vault.md) | **Accepted** | Replaces VeraCrypt with per-file AES-256-GCM vault objects, encrypted index, password + recovery key, remember-on-this-PC; desktop, plus Android tablet via USB-C OTG (amended 2026-09-24) |
