...
| [0038 Asset lifecycle authority](0038-asset-lifecycle-authority.md) | Proposed | Server-owned Asset identity/lifecycle + cloud-first Capture promotion; PC materializes under the same ID, Android/PC replicate lifecycle, mobile invalidates cached views from a list generation. **Implemented and verified locally; not activated.** Physical R2 GC remains deferred |
