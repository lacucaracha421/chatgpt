...
- `operations/catalog-hybrid-count-gate.md` — final CATALOG-007A prepared/routed COUNT, grouped API/UI, and isolated native Tauri acceptance evidence; preserves the earlier stopped gate as history.
