...
const mocks=vi.hoisted(()=>({quit:vi.fn(),quitHandler:null as null|(()=>Promise<void>),pending:false,flush:vi.fn(),close:vi.fn(),message:vi.fn(),handler:null as null|((e:{preventDefault:()=>void})=>Promise<void>)}));
