...
export type PublicationKind = "catalog" | "collections" | "characters";
...
export const publicationLabel = (kind: PublicationKind) => kind === "catalog" ? "카탈로그 게시" : kind === "characters" ? "모바일 캐릭터 업데이트" : "모바일 컬렉션 업데이트";
