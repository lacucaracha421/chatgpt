 ...
 */
export function LibraryHeader({title,count,crumbs,onBack,onOptions,changed=0,kind,loading}:{loading?:string|false;title:string;count?:number|string;crumbs:LibraryCrumb[];onBack():void;onOptions():void;changed?:number;/** A character folder shows its person/people glyph before the name. */kind?:CharacterFolderKind}) {
