...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::release_calendar::set_release_wishlist_muted,
            commands::release_calendar::acknowledge_release_wishlist_events,
            commands::release_calendar::run_due_release_wishlist,
            commands::artists::get_artist_overview,
            commands::artists::list_artists,
            commands::artists::get_artist,
            commands::artists::get_artist_today,
            commands::artists::list_artist_merge_suggestions,
            ...
            commands::artists::detach_artist_member,
            commands::artists::detach_artist_assignments,
